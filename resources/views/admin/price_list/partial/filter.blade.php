<div class="btn-group pricelist-price_list">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        {!! Form::select('search[type]')
                                          -> options([''=>'All']+trans('pricelist::price_list.options.type'))
                                          ->raw()!!}
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        {!! Form::select('search[status]')
                                         ->options([''=>'All']+trans('pricelist::price_list.options.status'))
                                         ->raw()!!}
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".pricelist-price_list .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/pricelist.price_list.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".pricelist-price_list .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.pricelist-price_list .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'pricelist.price_list.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#pricelist-price_list-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#pricelist-price_list-list .btn-reset-filter').css('display', 'none');
